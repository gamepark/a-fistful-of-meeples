...
import {drawCardInPlayerView, drawCardInView, isDrawCardView} from '@gamepark/a-fistful-of-meeples/moves/DrawCard'
import MoveType from '@gamepark/a-fistful-of-meeples/moves/MoveType'
import MoveView from '@gamepark/a-fistful-of-meeples/moves/MoveView'
import {spendGold} from '@gamepark/a-fistful-of-meeples/moves/SpendGold'
 ...
 */
export default class AFistfulOfMeeplesView implements Game<GameView, MoveView> {
  state: GameView
