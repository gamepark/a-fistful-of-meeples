 ...
 */
export type AFistfulOfMeeplesOptions = GameOptions<{}, AFistfulOfMeeplesPlayerOptions>
 ...
 */
export const AFistfulOfMeeplesOptionsDescription: OptionsDescription<{}, AFistfulOfMeeplesPlayerOptions> = {
  players: {
    id: {
